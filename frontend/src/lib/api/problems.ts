...
export const problemsApi = {
  ...
  create: (data: { title: string; description: string; priority: string; ci_id?: number | null }) =>
  ...
  resolve: (id: number, root_cause: string, workaround?: string) =>
    api.post<Problem>(`/problems/${id}/resolve`, { root_cause, workaround }),
};
